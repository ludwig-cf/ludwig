...
#include "coords.h"
#include "field_s.h"
#include "symmetric_aoft.h"

static __constant__ fe_symm_aoft_param_t const_param;

static fe_vt_t fe_symm_aoft_hvt = {
  (fe_free_ft)      fe_symm_aoft_free,
  (fe_target_ft)    fe_symm_aoft_target,
  (fe_fed_ft)       fe_symm_aoft_fed,
  (fe_mu_ft)        fe_symm_aoft_mu,
  (fe_mu_solv_ft)   NULL,
  (fe_str_ft)       fe_symm_aoft_str,
  (fe_str_ft)       fe_symm_aoft_str,
  (fe_str_ft)       NULL,
  (fe_hvector_ft)   NULL,
  (fe_htensor_ft)   NULL,
  (fe_htensor_v_ft) NULL,
  (fe_stress_v_ft)  fe_symm_aoft_str_v,
  (fe_stress_v_ft)  fe_symm_aoft_str_v,
  (fe_stress_v_ft)  NULL
};


static  __constant__ fe_vt_t fe_symm_aoft_dvt = {
  (fe_free_ft)      NULL,
  (fe_target_ft)    NULL,
  (fe_fed_ft)       fe_symm_aoft_fed,
  (fe_mu_ft)        fe_symm_aoft_mu,
...
__host__ int fe_symm_aoft_create(pe_t * pe, cs_t * cs, field_t * phi,
			    field_grad_t * dphi, field_t * temperature, io_options_t * options, fe_symm_aoft_t ** p) {

  int ndevice;
  fe_symm_aoft_t * obj = NULL;
  ...
  obj = (fe_symm_aoft_t *) calloc(1, sizeof(fe_symm_aoft_t));
  assert(obj);
  if (obj == NULL) pe_fatal(pe, "calloc(fe_symm_aoft_t) failed\n");

  obj->param = (fe_symm_aoft_param_t *) calloc(1, sizeof(fe_symm_aoft_param_t));
  assert(obj->param);
  if (obj->param == NULL) pe_fatal(pe, "calloc(fe_symm_aoft_param_t failed\n");
  ...
  obj->options = options;
  obj->super.func = &fe_symm_aoft_hvt;
  obj->super.id = FE_SYMM_AOFT;
  ...
  if (ndevice == 0) {
    ...
    fe_symm_aoft_param_t * tmp = NULL;
    fe_vt_t * vt;
    tdpMalloc((void **) &obj->target, sizeof(fe_symm_aoft_t));
    tdpMemset(obj->target, 0, sizeof(fe_symm_aoft_t));
    tdpGetSymbolAddress((void **) &tmp, tdpSymbol(const_param));
    tdpMemcpy(&obj->target->param, &tmp, sizeof(fe_symm_aoft_param_t *),
	      tdpMemcpyHostToDevice);
    tdpGetSymbolAddress((void **) &vt, tdpSymbol(fe_symm_aoft_dvt));
...
__host__ int fe_symm_aoft_free(fe_symm_aoft_t * fe) {
...
__host__ int fe_symm_aoft_target(fe_symm_aoft_t * fe, fe_t ** target) {
...
/****************************************************************************
 *
 *  fe_symm_aoft_kernel_commit
 *
 ****************************************************************************/

__host__ int fe_symm_aoft_kernel_commit(fe_symm_aoft_t * fe) {

  assert(fe);

  tdpMemcpyToSymbol(tdpSymbol(const_param), fe->param, sizeof(fe_symm_aoft_param_t),
...
__host__ int fe_symm_aoft_param_set(fe_symm_aoft_t * fe, fe_symm_aoft_param_t values) {

  assert(fe);

  *fe->param = values;

  fe_symm_aoft_kernel_commit(fe);
...
__host__ __device__
int fe_symm_aoft_param(fe_symm_aoft_t * fe, fe_symm_aoft_param_t * values) {
...
__host__ __device__
int fe_symm_aoft_fed(fe_symm_aoft_t * fe, int index, double * fed) {
...
__host__ __device__
int fe_symm_aoft_mu(fe_symm_aoft_t * fe, int index, double * mu) {
...
__host__ __device__
int fe_symm_aoft_str(fe_symm_aoft_t * fe, int index,  double s[3][3]) {
