...
Note that if something more complicated is required, for example,
an equilibration at zero shear followed by a run with shear, one
needs to be careful how this is arranged. The code works out the
...
$t = 0$, otherwise an offset is required. At the moment this cannot
be done via the input.
