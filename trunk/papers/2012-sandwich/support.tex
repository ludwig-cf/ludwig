...
for Fig. 3 in the main manuscript, where the switching of colloids in
blue phase III is studied. 
...
of 100 V/$\mu$m corresponds to a value of ${\cal E}\sim 0.4$ (considering
a value of $\gamma=3.0857$ as in Fig. 3 of the main text.
...
Final state of the end of the simulation in Fig.~1A. The movie
shows a rotation of the configuration to better appreciate details.\\

{\bf Supplementary Movie 2:} 
Final state of the end of the simulation in Fig.~1B. The movie
shows a rotation of the configuration to better appreciate details.\\

{\bf Supplementary Movie 3:} 
Final state of the end of the simulation in Fig.~1C. The movie
shows a rotation of the configuration to better appreciate details. \\

{\bf Supplementary Movie 4:} 
Final state of the end of the simulation in Fig.~1D. The movie
shows a rotation of the configuration to better appreciate details. \\ 

{\bf Supplementary Movie 5:} 
Final state at the end of the initial relaxation phase in Fig.~3. The movie
shows a rotation of the configuration to better appreciate details. The distribution of the colloidal particles is isotropic with the particles forming clusters and having a tendency to occupy positions a the intersection of the BPIII disclination lines.\\
