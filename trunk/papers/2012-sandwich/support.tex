...
``redshift''~\cite{mermin}): this would lead to quantitatively different 
...
The following protocol is used for the simulations of BPIII with
colloidal particles. An initial configuration of
...
further evolution is observed. The colloidal particles, with weak
normal anchoring, are then inserted with random chosen positions,
