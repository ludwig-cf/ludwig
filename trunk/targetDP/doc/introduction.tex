...
\begin{itemize}
    ...
    \item \keyword{CUDA}: Compute Unified Device Architecture. The parallel platform and model created by NVIDIA to allow general purpose programming of their GP architectures.
