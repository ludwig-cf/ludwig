...
int test_bond_fene2_with_state(pe_t * pe, cs_t * cs);
int test_create_dimer(colloids_info_t * cinfo, double a, double r1[3],
                      double r2[3], colloid_t * pc[2]);
int test_create_dimer_with_state(colloids_info_t * cinfo, double a, double r1[3],
                      double r2[3], colloid_t * pc[2]);
...
int test_bond_fene_suite(void) {
  ...
  test_bond_fene2_with_state(pe, cs);
...
int test_bond_fene2_with_state(pe_t * pe, cs_t * cs) {
  ...
  test_create_dimer_with_state(cinfo, dr, r1, r2, pc);
