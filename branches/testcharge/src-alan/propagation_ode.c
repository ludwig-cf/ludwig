...
static void propagation_ode_d2q9_rk2(hydro_t * hydro);
static void propagation_ode_d3q19_rk2(hydro_t * hydro);
static void propagation_ode_d2q9_rk4(hydro_t * hydro);
static void propagation_ode_d3q19_rk4(hydro_t * hydro);
static void propagation_ode_integrator_set(const int);
...
void propagation_ode(hydro_t * hydro) {
  ...
  switch (NDIM){
    case 2:
      if (integrator_type == RK2) propagation_ode_d2q9_rk2(hydro);
      if (integrator_type == RK4) propagation_ode_d2q9_rk4(hydro);
      break;
    case 3:
      if (integrator_type == RK2) propagation_ode_d3q19_rk2(hydro);
      if (integrator_type == RK4) propagation_ode_d3q19_rk4(hydro);
      break;
  }
  return;
}
...
void propagation_ode_d2q9_rk2(hydro_t * hydro) {
...
static void propagation_ode_integrator_set(const int type) {
