...
__host__ int noise_create(coords_t * cs, noise_t ** pobj);
...
__host__ int noise_state_set(noise_t * obj, int index,
			     unsigned int s[NNOISE_STATE]);
__host__ int noise_state(noise_t * obj, int index,
			 unsigned int s[NNOISE_STATE]);
__host__ int noise_reap(noise_t * obj, int index, double * reap);
__host__ int noise_reap_n(noise_t *obj, int index, int nmax, double * reap);
__host__ int noise_uniform_double_reap(noise_t * obj, int index, double * reap);
__host__ int noise_present(noise_t * obj, noise_enum_t type, int * present);
...
__host__ unsigned int noise_uniform(unsigned int state[NNOISE_STATE]);
