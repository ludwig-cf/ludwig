...
int psi_init_param_rt(psi_t * psi,  rt_t * rt) {
  ...
  psi_epsilon2_set(psi, epsilon); /* Default is no dielectric contrast */
  ...
  psi_bjerrum_length(psi, &lbjerrum);
