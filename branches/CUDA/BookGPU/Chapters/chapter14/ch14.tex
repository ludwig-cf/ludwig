...
\section{Introduction} \index{lattice Boltzmann} \index{complex fluids}
...
\section{Background}\label{ch14:sec:background} \index{lattice Boltzmann} \index{complex fluids} \index{MPI}
...
\section{Single GPU Implementation}\label{ch14:sec:singlegpu} \index{CUDA}
...
\section{Multiple GPU Implementation}\label{ch14:sec:parallelgpu} \index{multi-GPU programming} \index{MPI} \index{parallel scaling}
...
\section{Moving Solid Particles}\label{ch14:sec:particles} \index{particle-fluid interaction} \index{molecular dynamics}
