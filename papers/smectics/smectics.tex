...
\noindent\large{\textbf{O. Henrich\textit{$^{a}$}, D. Marenduzzo\textit{$^{a}$}, K. Stratford\textit{$^{b}$} and M.E. Cates \textit{$^{a}$}}
}\vspace{0.5cm}
...
\footnotetext{\textit{$^{a}$~SUPA, School of Physics and Astronomy, University of Edinburgh, JCMB Kings Buildings, Mayfield Road, Edinburgh, EH9 3JZ, Scotland.}}
\footnotetext{\textit{$^{b}$~EPCC, School of Physics and Astronomy, University of Edinburgh, JCMB Kings Buildings, Mayfield Road, Edinburgh, EH9 3JZ, Scotland.}}
