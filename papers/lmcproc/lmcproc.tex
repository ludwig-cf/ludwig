...
% DAVIDE (?): Page 6, sentence ``It is interesting to note that the
% secondary flow in the BP does not match the direction...'' Mike says
% ``incomprehensible''
% ANYONE: Please add reference ''to explain strange p_0/rho bit in
% equation 5''. 
