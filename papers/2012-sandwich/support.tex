...
\end{center}
\caption{Particle distribution for switched electric field direction: 
The field is now oriented along x (it was oriented along z in Fig.7 and Fig.3 main article). 
The leftmost panel shows the configuration with the disclination lines removed 
for clarity. The centre left picture shows the Fourier transform of the colloids for   
wavevectors $k_y, k_z\in [-3\pi/8,3\pi/8]$. The centre right panels depicts the residual 
anisotropy after switch off.}
\end{figure}
