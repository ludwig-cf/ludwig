...
\includegraphics[width=0.5\columnwidth]{support-fig7d.png}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.24\columnwidth]{support-fig8a.png}
\includegraphics[width=0.24\columnwidth]{support-fig8b.png}
\includegraphics[width=0.24\columnwidth]{support-fig8c.png}
\includegraphics[width=0.24\columnwidth]{support-fig8d.png}\\
\includegraphics[width=0.24\columnwidth]{support-fig8e.png}
\includegraphics[width=0.24\columnwidth]{support-fig8f.png}
\includegraphics[width=0.24\columnwidth]{support-fig8g.png}
\includegraphics[width=0.24\columnwidth]{support-fig8h.png}
\end{center}
\caption{Particle distribution and structure factor in electric fields and after switch-off:
The top images show the ordering of the particles in an electric field along the x-direction 
after a previous run which had the field along z. For clarity all disclination lines have
been removed and the view is with the field direction into the paper plane. 
The bottom row depicts results for a consecutive run with the field now 
oriented along the y-direction. In the left panels the field is on, whereas the right panels 
show the situation after switch-off. 
The structure factor data is for wave vectors $k_y, k_z \in [-3\pi/8 , 3\pi/8]$.}
\end{figure}
