...
xyz = utils.file_to_array("vesicle_tools/rawfiles/fullerene.xyz")
...
COL61 = xyz[:,60]
COL61 /= np.sqrt(np.sum(COL61**2))

R61 = utils.rotate(COL61, M)

for i, vec in enumerate(xyzt):
  newvec = np.dot(R61.T, vec)
  xyz[0][i] = newvec[0]
  xyz[1][i] = newvec[1]
  xyz[2][i] = newvec[2]
...
np.savetxt("latticeFullerene.txt", table, fmt = '%3d     %3f %3f %3f      %3d %3d %3d %3d %3d %3d %3d %3d   %3f %3f %3f %3f %3f %3f %3f    %3d %3d %3d')
