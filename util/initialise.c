 ...
 *  M_zrot
 *
 *  Matrix and inverse matrix for rotation around z-axis
 *
 ****************************************************************************/
void M_zrot(double ** M, double alpha){
