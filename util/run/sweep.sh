...
# META PARAMETERS
SWEEP_DIR=$PWD
LUDWIG_DIR="/home/jbertran/ludwig3"
...
sweepingParam="mask_std_width"
sweepingRange=(1.0 1.5 2.0 2.5 3.0)

sweepingParam2="phi_interaction_external_only"
sweepingRange2=(0 1)
...
for param in ${sweepingRange[@]}; do
  ...
  for param2 in ${sweepingRange2[@]}; do
    ...
    sed -i "s/XXXisfixedr_centreXXX/$isfixedr_centre/g" trisphere_init.c;
