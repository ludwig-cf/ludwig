...
ParaView \\
(\hyperref[ParaView]{https://www.paraview.org}), the MPI-library 
...
(\hyperref[GitHubLudwig]{https://github.com/ludwig-cf/ludwig}).
\smallskip
...
the command \texttt{make pdf} twice in the \texttt{/docs} directory:
